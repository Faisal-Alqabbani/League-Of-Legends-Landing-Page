...
import "./chmpion-card.scss";
function ChamponCard(props) {
  ...
  return (
    <div className="champion-card" onClick={handleClick} ref={cardRef}>
      <div className="frame">
        <div
      ...
      <img src={item.img} alt="camp" />
      <div className="name">{item.name}</div>
    </div>
  );
}

export default ChamponCard;
